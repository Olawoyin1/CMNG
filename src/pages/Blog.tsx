      ...
      <section className="py-10 px-4 md:px-0 bg-gray-50">
        <div className="container mx-auto ">
          ...
          <div className="mb-12 md:h-70 overflow-hidden">
            <div className="bg-white rounded-xl  overflow-hiden shadow-md">
              <div className="md:flex">
                <div className="md:w-1/2">
                  <img 
                    src={blogPosts[0].image} 
                    alt={blogPosts[0].title}
                    className="h-50 w-full object-cover md:h-70"
                  />
                </div>
                ...
                <div className="card-content p-1 py-4 flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-center text-xs text-gray-500">
                            ...
                            <span className="text-xs mr-3 text-[#ee774f] font-medium">
                            {post.category}
                            </span>
                        ...
                        <p className="line-clamp-2 text-sm">{post.excerpt} <Link to={`/blog/${post.id}`} className=" text-[#ee774f] text-sm hover:text-careersng-purple-dark p-0 h-auto">
                            Read More →
                        </Link></p>
                    </div>
